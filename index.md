...
Label-free imaging is a method for visualizing cells that have not been labeled or altered, so cells are analyzed in their native, unperturbed state. Findings are therefore more reliable and biologically relevant. A combination of contrast-improving optics and image analysis algorithms are used to analyze cell cultures. Accurate segmentation of individual cells enables the exploration of complex biological questions. Recently, deep-learning-based algorithms have shown superior performances for cell segmentation tasks. In this work, I use Deep Learning techniques to train a model and evaluate its segmentation accuracy. 
